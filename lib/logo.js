...
class Logo {
  ...
  generate() {
    ...
    const textSvg = `<text x="50%" y="50%" text-anchor="middle" dominant-baseline="middle" fill="${this.textColor}" font-family="New york times" font-weight="bold" font-size="50" dy="0.2em">${this.text}</text>`;
